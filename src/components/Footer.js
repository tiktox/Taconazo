      ...
      <div className="footer-content">
        <div className="footer-section brand-section">
          ...
          <p className="brand-description">
            Síguenos en nuestras redes sociales y participa en numerosos concursos que tenemos para ti!
          </p>
        ...
        <div className="footer-section legal-section">
          <h3>Legal</h3>
          <ul>
            <li><a href="#" onClick={(e) => {e.preventDefault(); alert('¡Próximamente disponible!')}} className="footer-link">Política y privacidad</a></li>
            <li><a href="#" onClick={(e) => {e.preventDefault(); alert('¡Próximamente disponible!')}} className="footer-link">Términos y servicios</a></li>
            <li><a href="#" onClick={(e) => {e.preventDefault(); alert('¡Próximamente disponible!')}} className="footer-link">Aviso de cookies</a></li>
          </ul>
        </div>

        <div className="footer-section newsletter-section">
          <h3>Suscríbete para recibir las últimas noticias y actualizaciones</h3>
      ...
      <div className="footer-bottom">
        <div className="footer-bottom-content">
          ...
          <div className="footer-badges">
            <span className="badge">🌮 Auténtico</span>
            <span className="badge">🔥 Fresco</span>
            <span className="badge">❤️ Hecho con amor</span>
          </div>
        </div>
      </div>
    </footer>
